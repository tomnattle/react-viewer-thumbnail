...
class App extends React.Component {
    constructor(props) {
        super(props);
        this.handleChangeModal = (e) => {
            this.setState({
                mode: 'modal',
            });
        };
        this.handleChangeInline = (e) => {
            this.setState({
                mode: 'inline',
                visible: true,
            });
    ...
    render() {
        ...
        <div className="container">
          <div className="wrap">
            <div>
              ...
              <div className="options">
                ...
                <List className="options-list" bordered dataSource={optionData} renderItem={item => {
            let content = null;
            switch (item.type) {
                case 'boolean':
                    content = (<Checkbox checked={this.state[item.key]} onChange={() => { this.handleOption(item.key); }}>
                            {item.key}
                          </Checkbox>);
                    break;
                default:
            ...
            return (<div key={index.toString()} className="img-item">
          ...
          <Viewer visible={this.state.visible} onClose={() => {
            this.setState({ visible: false });
        }} images={images} activeIndex={this.state.activeIndex} container={inline ? this.container : null} downloadable customToolbar={(toolbars) => {
