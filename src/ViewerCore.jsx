...
export default (props) => {
    const { visible = false, onClose = noop, images = [], activeIndex = 0, zIndex = 1000, drag = true, attribute = true, zoomable = true, rotatable = true, scalable = true, onMaskClick = noop, changeable = true, customToolbar = (toolbars) => toolbars, zoomSpeed = .05, disableKeyboardSupport = false, noResetZoomAfterChange = false, noLimitInitializationSize = false, defaultScale = 1, loop = true, disableMouseZoom = false, downloadable = false, noImgDetails = false, noToolbar = false, showTotal = true, totalName = 'of', minScale = 0.1, } = props;
    const initialState = {
        visible: false,
        visibleStart: false,
        transitionEnd: false,
    ...
    function reducer(s, action) {
        switch (action.type) {
            case ACTION_TYPES.setVisible:
                return Object.assign(Object.assign({}, s), { visible: action.payload.visible });
            case ACTION_TYPES.setActiveIndex:
                return Object.assign(Object.assign({}, s), { activeIndex: action.payload.index, startLoading: true });
            case ACTION_TYPES.update:
                return Object.assign(Object.assign({}, s), action.payload);
            case ACTION_TYPES.clear:
                return Object.assign(Object.assign({}, s), { width: 0, height: 0, scaleX: defaultScale, scaleY: defaultScale, rotate: 1, imageWidth: 0, imageHeight: 0, loadFailed: false, top: 0, left: 0, loading: false });
            default:
                break;
        }
        return s;
    ...
    return (<div className={className} style={viewerStryle} onTransitionEnd={() => {
        if (!visible) {
            dispatch(createAction(ACTION_TYPES.setVisible, {
                visible: false,
            }));
...
//# sourceMappingURL=ViewerCore.jsx.map