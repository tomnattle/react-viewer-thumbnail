...
class ViewerTester extends React.Component {
    ...
    render() {
        const _a = this.props, { hasContainer, images, onChangeImages } = _a, viewerProps = __rest(_a, ["hasContainer", "images", "onChangeImages"]);
        return (<div>
        ...
        <Viewer visible={this.state.visible} images={this.state.images} activeIndex={this.state.activeIndex} container={hasContainer ? this.container : false} onClose={() => { this.setState({ visible: false }); }} {...viewerProps}/>
      </div>);
    }
}
ViewerTester.defaultProps = {
    hasContainer: false,
};
...
describe('Viewer', () => {
    ...
    it('custom toolbar', () => {
        ...
        expect(handleClick).toBeCalledWith(expect.objectContaining({
            alt: 'lake',
...
//# sourceMappingURL=viewer.test.jsx.map